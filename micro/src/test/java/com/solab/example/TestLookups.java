...
public class TestLookups {
    ...
    public void testUnset() throws IOException {
        ...
        assertEquals(MaxProto.Response.ResultCase.ERROR, resp.getResultCase());
    }

    @Test
    public void testIpLookupMX() throws IOException {
        MaxProto.Response resp = send(req().setIp("72.229.28.185").build());
        assertEquals("MX", resp.getLoc().getCountryIso());
    }
    ...
    public void testIpLookupCambridge() throws IOException {
        ...
        assertEquals("CDMX", resp.getLoc().getCityName());
    }
    ...
    public void testTimeLookup() throws IOException {
        ...
        assertEquals(MaxProto.Response.ResultCase.TIME, resp.getResultCase());
        assertEquals(now, resp.getTime().getTimeSent());
        assertTrue(resp.getTime().getServerTime() >= now);
    }
